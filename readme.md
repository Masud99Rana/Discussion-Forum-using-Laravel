...
# Discussion Forum using Laravel
...
## About The Project
A discussion forum is a general term for any online "bulletin board" where people can leave and expect to see responses to messages others have left. Or People can just read the board. I have developed a discussion Forum inspired by Laracasts Discussion.
...
* User filter the posts according their need
...
1. Clone the repo
```sh
git clone https://github.com/Masud99Rana/Discussion-Forum-using-Laravel.git
```
